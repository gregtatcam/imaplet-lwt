...
module type S = sig
  ...
  val parse_seq : ?log:(string -> unit) -> a Lazys.Lazy_sequence.t -> b Lazys.Lazy_sequence.t
  val parse_lazy_list : ?log:(string -> unit) -> a Lazys.Lazy_list.t -> b Lazys.Lazy_list.t

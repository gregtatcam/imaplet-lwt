...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7c15c466ab864f8128c1cb8fabe9ad0c) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_data_files =
                        [
                           ...
                           ("../deploy/crt.pl", Some "$datadir/imaplet");
                           ("../deploy/imaplet.html",
                             Some "$datadir/imaplet");
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "imaplet_smtp.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\150*\168\1360-\165i\019g\158\228\146\160\179b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

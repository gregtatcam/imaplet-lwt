...
(* OASIS_START *)
(* DO NOT EDIT (digest: 356fc36b57499f52dc1d0be4dcdf5b7a) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "imaplet_email";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "imaplet_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Imaplet_types";
                           "storage/Irmin_core";
                           "storage/Irmin_storage";
                           "Install";
                           "Interpreter";
                           "Lazy_message";
                           "storage/Mailbox_storage";
                           "storage/Maildir_storage";
                           "Regex";
                           "Response";
                           "Seq_iterator";
                           "Server";
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Lex"; "Parser"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "imaplet_server";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "imaplet_email";
                           FindlibPackage ("nocrypto", None);
                           InternalLibrary "imaplet_server"
                        ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "|\026\138M\155d©µ\147\012\1324Ï/l\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

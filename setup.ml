...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4dda62787d2b7e826420cad22fddf6de) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "e\143n\132\158w\149j$g6=\r\018Âß";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
